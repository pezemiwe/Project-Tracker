...
describe('AnnualEstimatesEditor', () => {
  ...
  describe('Rendering', () => {
    it('should render with empty estimates', () => {
      ...
      expect(screen.getByText('No annual estimates defined')).toBeInTheDocument();
    });
  ...
  describe('Validation', () => {
    it('should validate sum equals estimated total', () => {
      ...
      expect(screen.queryByText('Matches estimated spend')).not.toBeInTheDocument();
      expect(screen.getByText(/Mismatch:/)).toBeInTheDocument();
    });
  ...
  describe('Disabled State', () => {
    ...
    it('should not show add year button when disabled', () => {
      ...
      expect(screen.queryByRole('button', { name: /add year/i })).not.toBeInTheDocument();
    });
